        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                     ...
                     */
                    ?>
                    <a href="{{ url('/es/formulario/create') }}" class="btn btn-success btn-sm" title="Add New Contact">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $curso->nombre }}</td>
                                    <td>{{ $curso->fecha }}</td>
                                    <td>@lang("formulario.$curso->dificultad")</td>

                                    <td>
                                        <a href="{{ url('/es/formulario/' . $curso->id) }}" title="View Student">
                                            <button class="btn btn-info btn-sm">
                                                <i class="fa fa-eye" aria-hidden="true"></i> @lang('formulario.ver')
                                            </button>
                                        </a>
